                    ...
                    <Col :md="12" :lg="24" :style="{marginBottom: '10px'}">
                        <Card>
                            <p slot="title" class="card-title">
                                ...
                                <a href="https://github.com/jiangbin216/jboot" target="_blank"> Github地址</a>
                            </p>
                            <div class="to-do-list-con">
                                <Timeline>
                                    <TimelineItem color="green">
                                        <a href="http://jmall.jiangbin.net.cn" target="_blank">JMall商城</a>
                                    </TimelineItem>
                                    <TimelineItem color="red">
                                        <a href="http://jpay.jiangbin.net.cn" target="_blank">JPay个人收款支付系统</a>
                                    </TimelineItem>
                                </Timeline>
                            </div>
                        </Card>
