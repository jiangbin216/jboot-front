<template>
    <Row type="flex" justify="center" align="middle" class="regist" @keydown.enter="submitRegist">
        <Col :xs="{span:22}" style="width: 368px;">
            <Row class="header">
                <img src="../images/jboot.png" width="220px"/>
                <div class="description">JBoot 前后端分离架构</div>
            </Row>
            ...
            <Row class="foot">
                ...
                <Row type="flex" justify="center" class="code-row-bg copyright">
                    Copyright © 2018 <a href="http://www.jiangbin.net.cn" target="_blank" style="margin:0 5px;">Gingerbread</a> Presents
                </Row>
            </Row>
        </Col>
    </Row>
    ...
    getVerifyCode() {
      this.getRequest("/common/captcha/init").then(res => {
        if (res.success === true) {
          ...
          this.verifyCodeImg = "/jboot/common/captcha/draw/" + this.captchaId;
        }
      });
    }
  },
